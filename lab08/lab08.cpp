...
vector<pair<double,double>> rungeKuttaSystemSolution(double (*fxu1)(double x, double y1, double y2),double (*fxu2)(double x, double y1, double y2), double a, double b, double n) {
    ...
    for (int i = 0; i < n; i++) {
        ...
        res.push_back(make_pair(yn + (k11 + 2 * k21 + 2 * k31 + k41) * h / 6 , yn2 + (k12 + 2 * k22 + 2 * k32 + k42) * h / 6));
...
vector<pair<double,double>> adamsSystemSolution(double (*fxu1)(double x, double y1, double y2),double (*fxu2)(double x, double y1, double y2), double a, double b, double n,vector<pair<double,double>> kutta) {
    vector<pair<double,double>> res;
    double h = (b - a) / n;
    res.reserve(n + 1);
    ...
    for (int i = 3; i < n; i++) {
        ...
        res.push_back(
                make_pair(yn + h * (55 * fxu1(xn, yn, _2yn) - 59 * fxu1(xn_1, yn_1, _2yn_1) + 37 * fxu1(xn_2, yn_2,_2yn_2) - 9 * fxu1(xn_3, yn_3,_2yn_3)) / 24 ,
				_2yn + h * (55 * fxu2(xn, yn, _2yn) - 59 * fxu2(xn_1, yn_1, _2yn_1) + 37 * fxu2(xn_2, yn_2,_2yn_2) - 9 * fxu2(xn_3, yn_3,_2yn_3)) / 24));
